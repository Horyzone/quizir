defmodule QuizirWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <div class="min-h-screen flex flex-col justify-between">
      ...
      <footer class="mt-auto border-t border-base-200 bg-base-100/70 backdrop-blur">
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8 border-b border-base-200">
            <!-- Présentation & Contexte Démonstrateur -->
            <div class="md:col-span-2 space-y-3">
              <div class="flex items-center gap-2">
                <img
                  ...
                  class="rounded-md"
                />
                <span class="text-lg font-black tracking-tight text-primary">Quizir</span>
                <span class="badge badge-sm badge-outline text-[11px] font-semibold">Démonstrateur technique</span>
              </div>
              <p class="text-xs sm:text-sm text-base-content/70 leading-relaxed max-w-md">
                Plateforme interactive de quiz multijoueurs en temps réel. Développée pour illustrer les compétences techniques en ingénierie logicielle avec Elixir, Phoenix LiveView et OTP.
              </p>
              <div class="flex flex-wrap items-center gap-2 pt-1 text-xs text-base-content/60">
            ...
            <!-- Navigation rapide -->
            <div>
              <h3 class="text-xs font-bold text-base-content uppercase tracking-wider mb-3">
                Navigation
              </h3>
              <ul class="space-y-2 text-xs">
                <%= if @is_admin do %>
                  <li>
                    <.link
                      navigate={~p"/admin"}
                      class="hover:text-primary transition-colors text-base-content/75"
                    >
            ...
            <div>
              ...
              <ul class="space-y-2 text-xs">
                <li>
                  <.link
                    id="footer-mentions-legales-link"
                    navigate={~p"/mentions-legales"}
                    class="hover:text-primary transition-colors text-base-content/75 flex items-center gap-1.5"
                  >
                    <.icon name="hero-information-circle" class="size-3.5 text-base-content/50" />
                ...
                <li>
                  <.link
                    ...
                    class="hover:text-primary transition-colors text-base-content/75 flex items-center gap-1.5"
                  >
                    <.icon name="hero-shield-check" class="size-3.5 text-base-content/50" />
          ...
          <!-- Bas de footer copyright & mentions rapides -->
          <div class="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-base-content/50">
            <p>
              © {Date.utc_today().year} Quizir · Projet à usage strictement démonstratif · Tous droits réservés.
            </p>
            <div class="flex items-center gap-4">
              <.link navigate={~p"/mentions-legales"} class="hover:underline">Mentions Légales</.link>
              <.link navigate={~p"/cgu"} class="hover:underline">CGU</.link>
              <.link navigate={~p"/rgpd"} class="hover:underline">RGPD</.link>
            </div>
          </div>
        </div>
      </footer>
